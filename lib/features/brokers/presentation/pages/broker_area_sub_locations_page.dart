...
class BrokerAreaSubLocationsPage extends StatelessWidget {
  final String brokerId;
  final String areaId;
  final String areaName;
  final String brokerName;

  const BrokerAreaSubLocationsPage({
    super.key,
            ...
            return ListView.separated(
              ...
              itemBuilder: (context, index) {
                ...
                return ListTile(
                  ...
                  onTap: () {
                    context.push(
                      '/broker/$brokerId/area/$areaId/sub-location/${item.id}',
                      extra: {
                        'areaName': areaName,
                        'brokerName': brokerName,
                        'subLocationName': item.name,
                      },
                    );
                  },
                );
